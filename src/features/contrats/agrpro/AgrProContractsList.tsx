// src/features/contrats/agrpro/AgrProContractsList.tsx
...
import { useAgrProContracts } from '@/hooks/useAgrProContracts'
...
export const AgrProContractsList = () => {
    const navigate = useNavigate()
    const emfId = 8 // AGR PRO EMF ID fixe
    ...
    const contrats = search.trim()
        ? allContrats.filter((c: AgrProContrat) =>
    ...
    console.log('🌿 AGR PRO - Contrats reçus:', contrats.length, contrats.slice(0, 2))
                    ...
                    {contrats.length === 0 ? (
                        <div className="text-center py-16 px-4">
                            ...
                            <h3 className="text-xl font-semibold text-gray-900 mb-2">
                                Aucun contrat AGR PRO trouvé
                            </h3>
                            <p className="text-gray-500 mb-8 max-w-md mx-auto">
                                Créez votre premier contrat AGR PRO pour commencer à gérer vos micro-assurances.
                            </p>
                            <Button
                                onClick={() => navigate('/contrats/nouveau/agrpro')}
                            ...
                            <table className="min-w-full divide-y divide-gray-200">
                                <thead className="bg-gray-50">
                                    <tr>
                                        ...
                                        <th className="px-6 py-4 text-left text-xs font-bold text-gray-900 uppercase tracking-wider">Ville</th>
                                    ...
                                    {contrats.map((contrat: AgrProContrat) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap">
                                                <Badge className="px-3 py-1 rounded-full text-xs font-semibold bg-emerald-100 text-emerald-800 border-emerald-200">
                                                    {contrat.ville || 'N/A'}
                                                </Badge>
                                            </td>
                                            <td className="px-6 py-4 whitespace-nowrap">
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap text-right space-x-1">
                                                <Button
                                                    ...
                                                    onClick={(e) => {
                                                        e.stopPropagation()
                                                        navigate(`/contrats/agrpro/${contrat.id}`)
                                                    }}
                                                ...
                                                <Button
                                                    ...
                                                    onClick={(e) => {
                                                        e.stopPropagation()
                                                        navigate(`/contrats/agrpro/${contrat.id}/edit`)
                                                    }}
