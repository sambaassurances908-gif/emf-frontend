...
interface EdgTaxiPrevoyanceDecesPrintProps {
    contrat: EdgTaxiPrevoyanceDecesContrat
}

export const EdgTaxiPrevoyanceDecesPrint: React.FC<EdgTaxiPrevoyanceDecesPrintProps> = ({ contrat }) => {
    return (
