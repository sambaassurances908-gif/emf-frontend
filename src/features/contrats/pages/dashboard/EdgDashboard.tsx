...
import { useEdgRecentContracts } from '@/hooks/useEdgRecentContracts'
...
export const EdgDashboard = () => {
  ...
  // Récupérer emf_id depuis state (LoginPage) ou localStorage ou user ou défaut à 4 (EDG)
  ...
  if (statsLoading || contratsLoading) {
    return (
      <div className="flex items-center justify-center h-[calc(100vh-4rem)]">
        <LoadingSpinner size="lg" text={`Chargement du dashboard EDG... (EMF #${emfId})`} />
      </div>
    )
  }
  ...
  if (statsError) {
    return (
      <div className="p-6 text-center text-red-600 bg-red-50 rounded-lg mx-6 mt-6">
        ...
        <p>Impossible de charger les statistiques EDG (EMF #{emfId}).</p>
  ...
  return (
    <div className="space-y-6 p-6 min-h-screen bg-gradient-to-br from-indigo-50 to-purple-100">
      {/* Header */}
      <div>
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div>
            <h1 className="text-3xl font-bold text-indigo-600 mb-2 flex items-center gap-2">
              💎 Dashboard EDG EMF #{emfId}
            </h1>
            <p className="text-gray-600">
              Bonjour {user?.name} - Gestion des contrats micro-assurance EDG
            </p>
            <p className="text-xs text-indigo-600 bg-indigo-50 px-3 py-1 rounded-full mt-1 inline-block">
          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Créer un contrat EDG</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">Nouvelle déclaration EDG</p>
              </div>
            </div>
          </CardContent>
        </Card>
                  ...
                  <div className="flex items-center gap-4 flex-1">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-sm text-gray-600">
                        N° {contrat.numero_police || 'N/A'} | {contrat.emf?.sigle || 'EDG'}
                      </p>
