      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-xl p-6 shadow-lg">
          ...
          <p className="mt-2 text-blue-100">
            Remplissez ce formulaire pour déclarer un sinistre sur un contrat BAMBOO EMF.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-4">
                  ...
                  >
                    ...
                    {contrats?.map((c: any) => (
                      <option key={c.id} value={c.id}>
                        {c.numero_police} - {c.nom_prenom} ({formatCurrency(c.montant_pret_assure || 0)})
                      </option>
                    ))}
                  </Select>
                ...
                {selectedContrat && (
                  <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
                    <h4 className="font-semibold text-blue-800 mb-2">Informations du contrat</h4>
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      ...
                      <div><span className="text-gray-600">Montant assuré:</span><span className="font-medium ml-2 text-blue-600">{formatCurrency(selectedContrat.montant_pret_assure || 0)}</span></div>
            ...
            <CardContent className="p-6 space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Input id="lieu_sinistre" value={formData.lieu_sinistre} onChange={(e) => setFormData({ ...formData, lieu_sinistre: e.target.value })} placeholder="Ex: Conakry, Matoto" />
                </div>
                <div>
                  <Label htmlFor="capital_restant_du" className="text-gray-700 font-medium"><DollarSign className="h-4 w-4 inline mr-1" />Capital restant dû (GNF) *</Label>
            ...
            <CardContent className="p-6 space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input id="telephone_declarant" type="tel" value={formData.telephone_declarant} onChange={(e) => setFormData({ ...formData, telephone_declarant: e.target.value })} placeholder="Ex: 620 XX XX XX" className={errors.telephone_declarant ? 'border-red-500' : ''} />
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {Object.entries(documentLabels).map(([key, label]) => {
                      ...
                      return (
                        <div key={key} className={`p-4 border rounded-lg ${isRequired ? 'border-purple-300 bg-purple-50' : 'border-gray-200 bg-gray-50'}`}>
          ...
          <div className="flex gap-4 justify-end">
            <Button type="button" variant="outline" onClick={() => navigate('/sinistres/bamboo')} disabled={isPending} className="border-gray-400">Annuler</Button>
            <Button type="submit" className="bg-blue-600 hover:bg-blue-700 px-8" disabled={isPending}>
