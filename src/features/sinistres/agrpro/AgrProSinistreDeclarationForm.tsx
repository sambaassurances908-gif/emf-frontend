// src/features/sinistres/agrpro/AgrProSinistreDeclarationForm.tsx
...
import { useAgrProContratsForSinistre, useCreateAgrProSinistre } from '@/hooks/useAgrProSinistres'
...
export const AgrProSinistreDeclarationForm = () => {
    const navigate = useNavigate()
    const [searchParams] = useSearchParams()
    const { user } = useAuthStore()
    const emfId = user?.emf_id || 8

    const urlContratId = searchParams.get('contrat_id') || ''

    const { data: contrats, isLoading: loadingContrats } = useAgrProContratsForSinistre(emfId)
    const { mutate: createSinistre, isPending } = useCreateAgrProSinistre()
    ...
    if (loadingContrats) {
        return (
            <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-emerald-50 to-teal-50">
                <LoadingSpinner size="lg" text="Chargement des contrats AGR PRO..." />
            </div>
        )
    }
            ...
            <div className="bg-white border-b border-slate-200 sticky top-0 z-10">
                <div className="max-w-5xl mx-auto px-4 py-4">
                    <div className="flex items-center justify-between">
                        <Button
                            variant="ghost"
                            onClick={() => navigate('/sinistres/agrpro')}
            ...
            <div className="max-w-5xl mx-auto px-4 py-8">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-slate-500 mt-2 max-w-xl mx-auto">
                        Remplissez ce formulaire pour déclarer un sinistre sur un contrat AGR PRO.
                    </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <Card className="overflow-hidden border-0 shadow-xl bg-white">
                        <CardHeader className="bg-gradient-to-r from-emerald-500 to-teal-600 text-white py-5">
                                    ...
                                    <div className="mt-4 p-5 bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl border border-emerald-200">
                                        ...
                                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                            ...
                                            <div className="bg-white p-3 rounded-xl shadow-sm">
                                                ...
                                                <div className="font-bold text-emerald-600">{formatCurrency(selectedContrat.montant_pret_assure || 0)}</div>
                                            </div>
                                            <div className="bg-white p-3 rounded-xl shadow-sm">
