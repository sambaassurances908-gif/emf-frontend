// src/features/sinistres/cofiga/CofigaSinistreDetailPage.tsx
...
export const CofigaSinistreDetailPage = () => {
    const { id } = useParams<{ id: string }>()
    const navigate = useNavigate()

    const { data: sinistre, isLoading, isError } = useQuery({
        queryKey: ['cofiga-sinistre', id],
        queryFn: async () => {
    ...
    if (isError || !sinistre) {
        return (
            <div className="flex flex-col items-center justify-center min-h-screen space-y-4">
                ...
                <Button onClick={() => navigate('/sinistres/cofiga')}>
            ...
            <div className="max-w-5xl mx-auto space-y-6">
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    <div>
                        <Button
                            variant="ghost"
                            onClick={() => navigate('/sinistres/cofiga')}
                        ...
                        <CardContent className="p-6 space-y-4">
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <p className="font-bold text-orange-600">{sinistre.numero_sinistre || `SIN-${sinistre.id}`}</p>
                                </div>
                                <div>
                    ...
                    <Card className="shadow-lg">
                        ...
                        <CardContent className="p-6 space-y-4">
                            ...
                            <Button
                                variant="outline"
                                className="w-full"
                                onClick={() => navigate(`/contrats/cofiga/${sinistre.contrat_id}`)}
                            >
                    ...
                    <Card className="shadow-lg">
                        ...
                        <CardContent className="p-6 space-y-4">
                            ...
                            <div>
                                ...
                                <p className="font-semibold">COFIGA - Coopérative Financière Gabonaise</p>
                            </div>
                        </CardContent>
                    </Card>
                </div>
...
export default CofigaSinistreDetailPage
