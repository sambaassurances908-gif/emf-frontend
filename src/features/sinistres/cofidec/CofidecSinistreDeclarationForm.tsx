...
export const CofidecSinistreDeclarationForm = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    console.log('📋 Payload COFIDEC:', payload)
  ...
  if (loadingContrats) {
    return (
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-slate-50 to-yellow-50">
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-yellow-50 to-orange-50">
      <div className="bg-white border-b border-slate-200 sticky top-0 z-10">
        <div className="max-w-5xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <Button variant="ghost" onClick={() => navigate('/sinistres/cofidec')} className="flex items-center gap-2 text-slate-600 hover:text-slate-900">
              <ArrowLeft className="h-4 w-4" />
              Retour aux sinistres
            </Button>
            <Badge className="bg-yellow-100 text-yellow-800 px-3 py-1">💰 COFIDEC</Badge>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto px-4 py-8">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 mt-2 max-w-xl mx-auto">Remplissez ce formulaire pour déclarer un sinistre sur un contrat COFIDEC.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <Card className="overflow-hidden border-0 shadow-xl bg-white">
            <CardHeader className="bg-gradient-to-r from-yellow-500 to-orange-500 text-white py-5">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <CardDescription className="text-yellow-100">Sélectionnez le contrat objet du sinistre</CardDescription>
                </div>
              </div>
            </CardHeader>
            <CardContent className="p-6">
              <div className="space-y-4">
                <div>
                  <Label className="text-slate-700 font-semibold flex items-center gap-2"><FileText className="h-4 w-4 text-yellow-500" />Contrat COFIDEC *</Label>
                ...
                {selectedContrat && (
                  <div className="mt-4 p-5 bg-gradient-to-br from-yellow-50 to-orange-50 rounded-2xl border border-yellow-200">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      ...
                      <div className="bg-white p-3 rounded-xl shadow-sm"><div className="text-xs text-slate-500 mb-1">Montant prêt</div><div className="font-bold text-yellow-600">{formatCurrency(selectedContrat.montant_pret || 0)}</div></div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-end pt-4">
            <Button type="button" variant="outline" onClick={() => navigate('/sinistres/cofidec')} disabled={isPending} className="h-12 px-6 border-slate-300"><ArrowLeft className="h-4 w-4 mr-2" />Annuler</Button>
            <Button type="submit" className="h-12 px-8 bg-gradient-to-r from-yellow-600 to-orange-600 hover:from-yellow-700 hover:to-orange-700 shadow-lg" disabled={isPending}>
