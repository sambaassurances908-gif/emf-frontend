// src/features/sinistres/cofidec/CofidecSinistreDetailPage.tsx
...
export const CofidecSinistreDetailPage = () => {
  ...
  if (isError || !sinistre) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen space-y-4">
        ...
        <Button onClick={() => navigate('/sinistres/cofidec')}>
      ...
      <div className="max-w-5xl mx-auto space-y-6">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            <Button 
              variant="ghost" 
              onClick={() => navigate('/sinistres/cofidec')}
              className="mb-2 hover:bg-orange-100"
            >
              <ArrowLeft className="h-4 w-4 mr-2" />
              Retour à la liste
            </Button>
            <h1 className="text-3xl font-bold text-[#F48232] flex items-center gap-3">
          ...
          <div className="flex gap-3">
            <Button
              ...
              className="border-orange-300 text-[#F48232] hover:bg-orange-50"
            >
          ...
          <Card className="shadow-lg">
            <CardHeader className="bg-gradient-to-r from-orange-50 to-amber-50 border-b">
              <CardTitle className="flex items-center gap-2">
                <AlertCircle className="h-5 w-5 text-[#F48232]" />
                Informations du sinistre
              </CardTitle>
            </CardHeader>
            <CardContent className="p-6 space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="font-bold text-[#F48232]">{sinistre.numero_sinistre || `SIN-${sinistre.id}`}</p>
                </div>
                <div>
            ...
            <CardContent className="p-6 space-y-4">
              <div className="grid grid-cols-1 gap-4">
                <div className="bg-orange-50 p-4 rounded-lg">
                  ...
                  <p className="text-2xl font-bold text-[#F48232]">
          ...
          <Card className="shadow-lg">
            ...
            <CardContent className="p-6 space-y-4">
              ...
              <Button
                variant="outline"
                className="w-full"
                onClick={() => navigate(`/contrats/cofidec/${sinistre.contrat_id}`)}
              >
          ...
          <Card className="shadow-lg">
            ...
            <CardContent className="p-6 space-y-4">
              ...
              <div>
                ...
                <p className="font-semibold">{sinistre.contrat?.emf?.sigle || 'COFIDEC'}</p>
              </div>
            </CardContent>
          </Card>
        </div>
        ...
        <Card className="shadow-lg">
          <CardHeader className="bg-gradient-to-r from-orange-50 to-amber-50 border-b">
            <CardTitle className="flex items-center gap-2">
              <Calendar className="h-5 w-5 text-[#F48232]" />
              Historique
            </CardTitle>
          </CardHeader>
          <CardContent className="p-6">
